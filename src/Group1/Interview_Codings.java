...
//                    
                ...
                public static void FINRA2(int [] arr) {
...
//                            myarr[i] = ""+(i+1);
                    ...
                    for(int j=0; j<myarr.length; j++) {
                        if(new Integer(arr[j])%3==0 && new Integer(arr[j])%5==0) 
                            myarr[j]="FINRA"; 
                        else if (new Integer(arr[j])%3==0) 
                            myarr[j]="FIN";
                        else if (new Integer(arr[j])%5==0) 
                            myarr[j]="RA";
                    else {
						myarr[j]= ""+arr[j];
					}
...
//                public void numsSorted (int[] num){
//
//                	//int[] numsSorted = new int[num.length];
//
